    ...
    <section id="solution" className="bg-conecta-yellow/5 py-24">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div className="flex space-x-4 items-start mb-6">
                  <div className="w-12 h-12 bg-conecta-yellow/20 rounded-full flex items-center justify-center flex-shrink-0">
                    <svg
                      ...
                      className="h-6 w-6 text-conecta-yellow"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
          ...
          <div className="lg:w-1/2">
            <h2 className="section-title text-conecta-yellow">
              A gente entende você — literalmente.
            </h2>
            <p className="text-xl text-gray-600 mb-8">
              Através de uma conversa guiada com IA e análise do seu GitHub,
              entendemos seu perfil técnico e comportamental. Depois, buscamos
              vagas personalizadas que realmente fazem sentido para você.
            </p>
            ...
            <div className="space-y-6 mt-8">
              <div className="flex gap-4 items-start">
                <div className="w-10 h-10 bg-conecta-yellow/20 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 text-conecta-yellow"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Nossa IA consegue extrair informações valiosas da sua
                    conversa e do seu GitHub.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Encontramos vagas que combinam com seu perfil, interesses e
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Maior probabilidade de sucesso nos processos seletivos e
                    encaixe na empresa.
                  </p>
                </div>
              </div>
