...
export type Routers = {
  ...
  '/internship/list': {
    post: {
      response: MergeUnion<UnwrapPromise<ReturnType<typeof ListInternship.methods.post>>>,
      request: undefined,
      auth: undefined
    }
  },
  ...
  '/chat/send': {
    post: {
      response: MergeUnion<UnwrapPromise<ReturnType<typeof chat.methods.post>>>,
      request: z.infer<NonNullable<typeof chat.schema>['post']>,
      auth: FirstParameter<typeof chat>
    }
  }
}